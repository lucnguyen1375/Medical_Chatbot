...
Spring Boot now owns Flyway migrations for the minimum app tables.
...
POST /api/chat persistence check: 1 session, 1 user message, 1 assistant message, 1 usage log
```
